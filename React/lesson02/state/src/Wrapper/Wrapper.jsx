...
class Wrapper extends Component {
    state = {
        phones:[
            ...
            },
            {
                ...
                reviews: 33,
                title: 'Apple iPhone Xs 64GB Space Gray',
                price: 28359,
                curency: 'UAH',
                screen: 5.8,
            ...
            },
            {
                ...
                reviews: 118,
                title: 'Samsung Galaxy S9 Plus 64GB',
                price: 25999,
                curency: 'UAH',
                screen: 6.2,
    ...
    componentDidMount() {
        fetch('http://content.guardianapis.com/small-business-network/2016/feb/22/startup-of-the-year-competition-entry-pavillion-at-the-park?show-blocks=body&api-key=test')
        .then(res => res.json())
    ...
    deleteFromCart = (e) => {
        let title = e.target.dataset.name;
        this.setState(prev => ({
            cart: prev.cart.filter(el => el.title !== title)
        }))
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/* {isCartShow && <Cart toggleCart = {this.toggleCart} cart = {cart} deleteFromCart={this.deleteFromCart}/>} */}
