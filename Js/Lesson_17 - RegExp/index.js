...
// var test = `Card Number : 4906962001841822
// Expiration : 02/2020
// CVV / CVC : 288
...
//
// const reg = /\d{16}|\d{4}\s\d{6}\s\d{6}|\d{4}\s\d{4}\s\d{4}\s\d{4}/g;

// const reg = /((?<=Card Number.:.)|(?<=Card Number:.)).+/g;


// console.log(sometext.match(reg));

// const test = `+38(068)547-89-87`;
// const test2 = `+38(032)584 69 98`;
// const reg = /\+38\(\d{3}\)([^\w]|)\d{3}([^\w]|)\d{2}([^\w]|)\d{2}/g;
//
//
